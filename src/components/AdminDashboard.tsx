...
type Order = { id: string; orderNumber: string; customerEmail: string | null; customerPhone: string | null; status: string; orderType: string; paymentMethod: string; deliveryAddress: string | null; total: number; createdAt: string; items: Array<{ id: string; name: string; price: number; quantity: number }> };
