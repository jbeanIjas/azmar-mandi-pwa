...
import { Boxes, FolderPlus, LayoutGrid, LogOut, PackagePlus, Pencil, Plus, Search, Trash2, X } from 'lucide-react';
...
export default function AdminDashboard({ initialCategories, initialProducts }: { initialCategories: Category[]; initialProducts: Product[] }) {
